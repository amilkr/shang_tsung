...
ERLC_EMULATOR=/usr/local/lib/erlang/erts-6.3/bin/erl
export ERLC_EMULATOR
ERL=/usr/local/lib/erlang/erts-6.3/bin/erl
ERLC=/usr/local/lib/erlang/erts-6.3/bin/erlc
SED=/usr/bin/sed
ERL_OPTS=
# FIXME
DIALYZER=/usr/local/lib/erlang/erts-6.3/bin/dialyzer
...
ERLANG_XMERL_DIR=/usr/local/lib/erlang/lib/xmerl-1.3.7/include

raw_erlang_prefix=${exec_prefix}/lib/erlang/

PACKAGE_TARNAME=tsung

prefix=/usr/local/lib/erlang/erts-6.3
exec_prefix=${prefix}
